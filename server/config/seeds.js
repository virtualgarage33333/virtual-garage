...
db.once("open", async () => {
  ...
  const items = await Item.insertMany([
    ...
    },
    {
      itemName: "Towel",
      price: 19.99,
      description: "The best towel",
      category: categories[4]._id,
    },
    {
      itemName: "Bag",
      price: 29.99,
      description: "The best bag",
      category: categories[4]._id,
    },
    {
      itemName: "Socks",
      price: 14.99,
      description: "The best socks",
      category: categories[4]._id,
    },
    {
      itemName: "Bike",
      price: 229.99,
      description: "The best bike",
    ...
    },
    {
      itemName: "Golf Club",
      price: 23.99,
      description: "The best golf club",
      category: categories[6]._id,
    },
    {
      itemName: "Baseball",
      price: 49.99,
      description: "The best baseball",
    ...
    },
    {
      itemName: "Football",
      price: 39.99,
      description: "The best football",
      category: categories[7]._id,
    },
    {
      itemName: "Other",
      price: 9.99,
      description: "The best other",
