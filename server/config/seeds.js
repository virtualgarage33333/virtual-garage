...
db.once('open', async () => {
    ...
    const items = await Item.insertMany([
        { itemName: 'iPhone X', price: 999.99, description: 'The latest iPhone', category: categories[0]._id, image: 'https://images.macrumors.com/t/1Qx7Upnlkr63vKmeNRIWm3JH3wI=/800x0/smart/https://images.macrumors.com/article-new/2017/09/iphonexdesign.jpg?lossy' },
